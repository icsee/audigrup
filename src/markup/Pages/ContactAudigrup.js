...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        console.log('el token es',this.props.token.token.token)
        this.props.postFeedback(values.firstname, values.telnum, values.email, values.message, this.props.token.token.token );
